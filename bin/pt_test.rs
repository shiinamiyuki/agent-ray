...
fn main() {
    ...
    let camera = PinholeCamera::new(
        Vec3A::new(1.2, 1.0, -2.2), // eye
        Vec3A::new(1.2, 1.0, 0.2),  // look-at
        Vec3A::new(0.0, 1.0, 0.0),  // up
        60.0,
        aspect_ratio,
    );
    ...
    let point_light = Arc::new(PointLight::new(
        Vec3A::new(0.0, 2.0, 0.0),      // world-space position
        Vec3A::new(150.0, 120.0, 80.0), // warm white (slightly orange-tinted)
    ));
