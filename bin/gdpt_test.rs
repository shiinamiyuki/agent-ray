...
use agent_ray::integrators::{GdptConfig, GradientDomainPathTracer, Integrator};
...
fn main() {
    ...
    let integrator = GradientDomainPathTracer::new(config);
